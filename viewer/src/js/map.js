(function(hdv, L, $, _) {
	...
	var map = {
		...
		addAttributionControl: function() {
			var attribution = '<a class="permalink">Permalink</a> &nbsp;&nbsp; <a class="datasources">Datenquellen</a> &nbsp;&nbsp; <a class="imprint">Impressum</a> | <a href="http://www.mapbox.com/about/maps/" target="_blank">Terms &amp; Feedback</a>';
